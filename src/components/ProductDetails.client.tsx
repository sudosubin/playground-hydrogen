...
import {UnitPriceMeasurement} from '@shopify/hydrogen/dist/esnext/graphql/types/types';

const ProductPriceMarkup: FC = () => {
  return (
    <div className="flex md:flex-col items-end font-semibold text-lg md:items-start md:mb-4">
      ...
      <Product.SelectedVariant.Price className="text-gray-900">
        {({currencyCode, amount, currencyNarrowSymbol}: UseMoneyValue) =>
      ...
      <Product.SelectedVariant.UnitPrice className="text-gray-500">
        {({
          ...
          referenceUnit,
        }: UseMoneyValue & UnitPriceMeasurement) =>
